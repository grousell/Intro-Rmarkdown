...
While RMarkdwon will translate to Latex, you can incorporate code in the document as well.  `**Bolded Text**` and `\textbf{Bolded Text}` will both result in **Bolded Text**. 
