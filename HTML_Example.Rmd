...
While RMarkdown will translate to HTML, you can incorporate code in the document as well.  `**Bolded Text**` and `<strong>Bolded Text</strong>` will both result in **Bolded Text**. 
...
Here is some text.  More and more and more.  
